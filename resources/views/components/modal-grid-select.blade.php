<form @submit="if (!selectedItem) event.preventDefault();">
    <div x-data="{ 
        ...
        <div @click="open = true; fetchItems()" x-text="selectedItem ? selectedItem.{{ $displayKey }} : 'Nenhum item selecionado'" class="mt-1 p-2 border rounded-md shadow-sm bg-gray-100 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 cursor-pointer"></div>
        ...
        <div x-show="open" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
            <div class="flex items-center justify-center min-h-screen p-4">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl overflow-hidden transform transition-all sm:my-8 sm:w-full sm:max-w-4xl z-50">
                    <div class="px-6 py-4">
                        <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-gray-100">{{ $label }}</h3>
                    </div>
                    ...
                    <div class="px-6 py-4 max-h-96 overflow-y-auto" @scroll.debounce.100ms="if ($el.scrollTop + $el.clientHeight >= $el.scrollHeight - 50) loadMore()">
                        ...
                        <div x-show="loading" class="text-center py-8">
                            ...
                            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Carregando dados...</p>
                        </div>
