<aside x-data="{ sidebarOpen: window.innerWidth >= 768 }"
     ...
     class="hidden md:flex top-0 left-0 h-screen bg-white dark:bg-gray-800 shadow-lg z-50 transition-all duration-300 overflow-hidden h-auto">

    <!-- Botão sempre visível no topo -->
    <div class="p-2 w-20 absolute top-0 left-0 z-10">
        <button
            @click="sidebarOpen = !sidebarOpen"
            class="bg-gray-200 rounded p-1 focus:outline-none"
    ...
    <div x-show="sidebarOpen" class="overflow-hidden pt-12 h-full">
        <div class="h-full flex flex-col justify-between">
            <div class="flex flex-col items-center mt-8">
                ...
                <nav class="w-full flex flex-col items-start space-y-2 px-4">
